/**********************************************************************
 *
 * kwNgUiFuse/cmp/link/kwUiLink.ts
 *
...
@Component({
    selector: 'kw-ui-link',
    templateUrl: 'kwUiLink.html',
    styleUrls: ['kwUiLink.scss']
})
export class kwUiLink extends kwNgUiCtrlComp {
    img: object;
    title: object;
...
//@formatter:on
    ...
    protected parseView(view: object): void {
        ...
        const type: kwtLink = <kwtLink>view;
