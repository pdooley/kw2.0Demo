...
import {kwtFrmDivLbl}           from "./kwtFrmDivLbl";
...
@Component({
    selector: 'kw-ui-frm-div-lbl',
    templateUrl: 'kwUiFrmDivLbl.html',
    styleUrls: ['kwUiFrmDivLbl.scss']
})
export class kwUiFrmDivLbl extends kwNgUiCtrlComp {
...
//@formatter:on
    ...
    protected parseView(view: object): void {
        ...
        const type: kwtFrmDivLbl = <kwtFrmDivLbl>view;
