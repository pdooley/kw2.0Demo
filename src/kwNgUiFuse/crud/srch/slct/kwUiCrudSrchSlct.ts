/**********************************************************************
 *
 * kwNgUiFuse/crud/srch/slct/kwUiCrudSrchSlct.ts
 *
...
import {kwGrid}                     from "../../../../kwUiAgGrid/class/grid/kwGrid";
...
import {kwUitCrudSrchSlct}              from "./kwUitCrudSrchSlct";


const sTAG: string = "slct";

@Component({
    selector:       'kw-ui-crud-srch-slct',
    templateUrl:    'kwUiCrudSrchSlct.html',
    styleUrls:      ['kwUiCrudSrchSlct.scss'],
    encapsulation:  ViewEncapsulation.None,
    animations:     fuseAnimations
})
export class kwUiCrudSrchSlct extends kwNgUiCtrlComp
{
...
*/
    ...
    public onSrchSlct(): void
    {
        const log: kwLog = new kwLog(this.sClass, "onSrchSlct");
        //console.log(log.called());
    ...
    protected parseView(view: any): void
    {
        ...
        const type: kwUitCrudSrchSlct = <kwUitCrudSrchSlct>(view);
