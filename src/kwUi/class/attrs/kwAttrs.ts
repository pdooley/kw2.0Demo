...
//@formatter:on
    ...
    public init(): boolean
    {
        ...
        //console.info(log.is("attrsIn", this.attrsIn));
        ...
        //console.info(log.is("view", this.view));
    ...
    private createAttrs(): boolean
    {
        ...
        for (let attr of this.attrsIn)
        {
            //console.info(log.isObj("attr"), attr, "]");

            const type: kwtAttrIn = {
                attr: attr,
                disp: this.disp,
                view: this.view
            };
